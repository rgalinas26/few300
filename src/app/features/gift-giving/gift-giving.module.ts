...
@NgModule({
  declarations: [GiftGivingComponent, NavComponent, DashboardComponent, RecipientsComponent, HolidaysComponent, HolidayEntrysComponent, HolidayListComponent, HolidayListControlsComponent],
  imports: [
    CommonModule,
